-- DTMS planning scenarios, consolidation, shipment/leg/run planning, tendering, dispatch, and appointments.

CREATE TABLE IF NOT EXISTS dtms.planning_scenarios (
...
CREATE TABLE IF NOT EXISTS dtms.planning_scenario_orders (
    scenario_id uuid NOT NULL REFERENCES dtms.planning_scenarios(id) ON DELETE CASCADE,
    order_id uuid NOT NULL REFERENCES dtms.transport_orders(id),
...
CREATE TABLE IF NOT EXISTS dtms.planning_constraints (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    scenario_id uuid NOT NULL REFERENCES dtms.planning_scenarios(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.planning_runs (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    scenario_id uuid NOT NULL REFERENCES dtms.planning_scenarios(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.planning_run_logs (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    planning_run_id uuid NOT NULL REFERENCES dtms.planning_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.planning_run_results (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    planning_run_id uuid NOT NULL REFERENCES dtms.planning_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.consolidation_groups (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    group_no varchar(80) NOT NULL,
    group_type varchar(30) NOT NULL,
    planning_scenario_id uuid REFERENCES dtms.planning_scenarios(id),
...
CREATE TABLE IF NOT EXISTS dtms.consolidation_group_orders (
    group_id uuid NOT NULL REFERENCES dtms.consolidation_groups(id) ON DELETE CASCADE,
    order_id uuid NOT NULL REFERENCES dtms.transport_orders(id),
...
CREATE TABLE IF NOT EXISTS dtms.shipments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_no varchar(100) NOT NULL,
    shipment_type varchar(30) NOT NULL DEFAULT 'DIRECT',
    planning_scenario_id uuid REFERENCES dtms.planning_scenarios(id),
    consolidation_group_id uuid REFERENCES dtms.consolidation_groups(id),
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    customer_id uuid REFERENCES dtms.business_partners(id),
    primary_mode_code varchar(20) REFERENCES dtms.transport_modes(mode_code),
    ...
    cost_currency_code char(3) REFERENCES dtms.currencies(currency_code),
...
CREATE TABLE IF NOT EXISTS dtms.shipment_orders (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_id uuid NOT NULL REFERENCES dtms.shipments(id) ON DELETE CASCADE,
    order_id uuid NOT NULL REFERENCES dtms.transport_orders(id),
...
CREATE TABLE IF NOT EXISTS dtms.shipment_stops (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_id uuid NOT NULL REFERENCES dtms.shipments(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.shipment_stop_orders (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    shipment_stop_id uuid NOT NULL REFERENCES dtms.shipment_stops(id) ON DELETE CASCADE,
    order_id uuid NOT NULL REFERENCES dtms.transport_orders(id),
    order_stop_id uuid REFERENCES dtms.transport_order_stops(id),
...
CREATE TABLE IF NOT EXISTS dtms.shipment_legs (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_id uuid NOT NULL REFERENCES dtms.shipments(id) ON DELETE CASCADE,
    leg_no integer NOT NULL,
    from_stop_id uuid NOT NULL REFERENCES dtms.shipment_stops(id),
    to_stop_id uuid NOT NULL REFERENCES dtms.shipment_stops(id),
    mode_code varchar(20) NOT NULL REFERENCES dtms.transport_modes(mode_code),
    service_level_id uuid REFERENCES dtms.service_levels(id),
    route_id uuid REFERENCES dtms.routes(id),
    planned_departure_at timestamptz,
    planned_arrival_at timestamptz,
    planned_distance_km numeric(16,3),
    planned_duration_minutes integer,
    carrier_id uuid REFERENCES dtms.business_partners(id),
    subcontract_carrier_id uuid REFERENCES dtms.business_partners(id),
...
CREATE TABLE IF NOT EXISTS dtms.shipment_leg_allocations (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    shipment_leg_id uuid NOT NULL REFERENCES dtms.shipment_legs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.shipment_services (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_id uuid NOT NULL REFERENCES dtms.shipments(id) ON DELETE CASCADE,
    shipment_stop_id uuid REFERENCES dtms.shipment_stops(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.shipment_milestones (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_id uuid NOT NULL REFERENCES dtms.shipments(id) ON DELETE CASCADE,
    shipment_leg_id uuid REFERENCES dtms.shipment_legs(id) ON DELETE CASCADE,
    shipment_stop_id uuid REFERENCES dtms.shipment_stops(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.transport_runs (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    mode_code varchar(20) NOT NULL REFERENCES dtms.transport_modes(mode_code),
    start_location_id uuid REFERENCES dtms.locations(id),
    end_location_id uuid REFERENCES dtms.locations(id),
    planned_start_at timestamptz,
    planned_end_at timestamptz,
    planned_distance_km numeric(16,3),
...
CREATE TABLE IF NOT EXISTS dtms.run_legs (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
    sequence_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.run_leg_allocations (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_leg_id uuid NOT NULL REFERENCES dtms.run_legs(id) ON DELETE CASCADE,
    shipment_leg_allocation_id uuid REFERENCES dtms.shipment_leg_allocations(id),
    order_line_id uuid NOT NULL REFERENCES dtms.transport_order_lines(id),
    handling_unit_id uuid REFERENCES dtms.handling_units(id),
    allocated_quantity numeric(20,6),
    quantity_uom_code varchar(20) REFERENCES dtms.units_of_measure(uom_code),
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_run_leg_allocations_scope
    ON dtms.run_leg_allocations (
        run_leg_id, order_line_id,
        COALESCE(handling_unit_id, '00000000-0000-0000-0000-000000000000'::uuid)
    );

CREATE TABLE IF NOT EXISTS dtms.run_stops (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
    sequence_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.run_stop_activities (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_stop_id uuid NOT NULL REFERENCES dtms.run_stops(id) ON DELETE CASCADE,
    shipment_stop_id uuid REFERENCES dtms.shipment_stops(id),
...
CREATE TABLE IF NOT EXISTS dtms.capacity_reservations (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.run_carrier_assignments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.run_driver_assignments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
    driver_id uuid NOT NULL REFERENCES dtms.drivers(id),
    assignment_role varchar(20) NOT NULL DEFAULT 'PRIMARY',
    valid_from timestamptz NOT NULL,
    valid_to timestamptz,
...
CREATE TABLE IF NOT EXISTS dtms.run_equipment_assignments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.assignment_status_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.route_plan_versions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.route_plan_segments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    route_plan_version_id uuid NOT NULL REFERENCES dtms.route_plan_versions(id) ON DELETE CASCADE,
    sequence_no integer NOT NULL,
    from_run_stop_id uuid REFERENCES dtms.run_stops(id),
    to_run_stop_id uuid REFERENCES dtms.run_stops(id),
...
CREATE TABLE IF NOT EXISTS dtms.tenders (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    status varchar(20) NOT NULL DEFAULT 'DRAFT',
    awarded_carrier_id uuid REFERENCES dtms.business_partners(id),
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conrelid = 'dtms.run_carrier_assignments'::regclass
          AND conname = 'fk_run_carrier_awarded_tender'
    ) THEN
        ALTER TABLE dtms.run_carrier_assignments
            ADD CONSTRAINT fk_run_carrier_awarded_tender FOREIGN KEY (awarded_tender_id)
            REFERENCES dtms.tenders(id) ON DELETE SET NULL;
    END IF;
END;
$block$;

CREATE TABLE IF NOT EXISTS dtms.tender_rounds (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tender_id uuid NOT NULL REFERENCES dtms.tenders(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.tender_offers (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    tender_round_id uuid NOT NULL REFERENCES dtms.tender_rounds(id) ON DELETE CASCADE,
    carrier_id uuid NOT NULL REFERENCES dtms.business_partners(id),
...
CREATE TABLE IF NOT EXISTS dtms.tender_responses (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tender_offer_id uuid NOT NULL REFERENCES dtms.tender_offers(id) ON DELETE CASCADE,
    ...
    created_by_user_id uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.tender_awards (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    tender_id uuid NOT NULL REFERENCES dtms.tenders(id) ON DELETE CASCADE,
    tender_response_id uuid REFERENCES dtms.tender_responses(id),
    carrier_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    award_amount numeric(20,4) NOT NULL,
    currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    awarded_by uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.dispatch_orders (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    dispatch_no varchar(100) NOT NULL,
    revision_no integer NOT NULL DEFAULT 1,
    carrier_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    run_id uuid NOT NULL REFERENCES dtms.transport_runs(id),
    tender_award_id uuid REFERENCES dtms.tender_awards(id),
...
CREATE TABLE IF NOT EXISTS dtms.dispatch_instructions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    dispatch_order_id uuid NOT NULL REFERENCES dtms.dispatch_orders(id) ON DELETE CASCADE,
    sequence_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.dispatch_acknowledgements (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    dispatch_order_id uuid NOT NULL REFERENCES dtms.dispatch_orders(id) ON DELETE CASCADE,
    instruction_id uuid REFERENCES dtms.dispatch_instructions(id),
...
CREATE TABLE IF NOT EXISTS dtms.dispatch_status_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    dispatch_order_id uuid NOT NULL REFERENCES dtms.dispatch_orders(id) ON DELETE CASCADE,
    from_status varchar(20),
...
CREATE TABLE IF NOT EXISTS dtms.dock_appointments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    appointment_no varchar(100) NOT NULL,
    location_id uuid NOT NULL REFERENCES dtms.locations(id),
    dock_id uuid REFERENCES dtms.location_docks(id),
    order_stop_id uuid REFERENCES dtms.transport_order_stops(id),
    shipment_stop_id uuid REFERENCES dtms.shipment_stops(id),
    ...
    driver_id uuid REFERENCES dtms.drivers(id),
...
CREATE TABLE IF NOT EXISTS dtms.dock_appointment_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    appointment_id uuid NOT NULL REFERENCES dtms.dock_appointments(id) ON DELETE CASCADE,
    from_status varchar(20),
    to_status varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.manifests (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.manifest_items (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    manifest_id uuid NOT NULL REFERENCES dtms.manifests(id) ON DELETE CASCADE,
    sequence_no integer NOT NULL,
    order_id uuid REFERENCES dtms.transport_orders(id),
    shipment_id uuid REFERENCES dtms.shipments(id),
    handling_unit_id uuid REFERENCES dtms.handling_units(id),
