-- DTMS execution ledger, control tower, telematics, driver workflow, POD, exceptions, and incidents.

CREATE TABLE IF NOT EXISTS dtms.transport_events (
    ...
    dispatch_order_id uuid REFERENCES dtms.dispatch_orders(id),
    ...
    causation_id uuid REFERENCES dtms.transport_events(id),
...
CREATE TABLE IF NOT EXISTS dtms.shipment_status_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    reason_text text,
    source_event_id uuid REFERENCES dtms.transport_events(id),
    changed_by uuid REFERENCES dtms.users(id),
    occurred_at timestamptz NOT NULL,
    received_at timestamptz NOT NULL DEFAULT now()
);

CREATE TABLE IF NOT EXISTS dtms.run_status_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.stop_executions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_stop_id uuid NOT NULL REFERENCES dtms.run_stops(id),
    dispatch_order_id uuid REFERENCES dtms.dispatch_orders(id),
...
CREATE TABLE IF NOT EXISTS dtms.run_leg_executions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_leg_id uuid NOT NULL REFERENCES dtms.run_legs(id),
    attempt_no integer NOT NULL DEFAULT 1,
    dispatch_order_id uuid REFERENCES dtms.dispatch_orders(id),
    driver_id uuid REFERENCES dtms.drivers(id),
    vehicle_id uuid REFERENCES dtms.vehicles(id),
...
CREATE TABLE IF NOT EXISTS dtms.stop_status_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    stop_execution_id uuid NOT NULL REFERENCES dtms.stop_executions(id) ON DELETE CASCADE,
    from_status varchar(30),
    to_status varchar(30) NOT NULL,
    reason_code varchar(80),
    source_event_id uuid REFERENCES dtms.transport_events(id),
...
CREATE TABLE IF NOT EXISTS dtms.milestone_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_milestone_id uuid REFERENCES dtms.shipment_milestones(id),
...
CREATE TABLE IF NOT EXISTS dtms.gps_positions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    device_id uuid REFERENCES dtms.telematics_devices(id),
    vehicle_id uuid REFERENCES dtms.vehicles(id),
    driver_id uuid REFERENCES dtms.drivers(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
...
CREATE TABLE IF NOT EXISTS dtms.geofence_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    geofence_id uuid NOT NULL REFERENCES dtms.geofences(id),
    vehicle_id uuid REFERENCES dtms.vehicles(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    run_stop_id uuid REFERENCES dtms.run_stops(id),
    event_type varchar(20) NOT NULL,
    gps_position_id uuid REFERENCES dtms.gps_positions(id),
    occurred_at timestamptz NOT NULL,
    received_at timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS dtms.eta_predictions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    shipment_id uuid REFERENCES dtms.shipments(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    ...
    input_position_id uuid REFERENCES dtms.gps_positions(id),
...
CREATE TABLE IF NOT EXISTS dtms.driver_shifts (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.driver_duty_logs (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    driver_id uuid NOT NULL REFERENCES dtms.drivers(id),
    shift_id uuid REFERENCES dtms.driver_shifts(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    ...
    correction_of_id uuid REFERENCES dtms.driver_duty_logs(id),
...
CREATE TABLE IF NOT EXISTS dtms.driver_tasks (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    driver_id uuid NOT NULL REFERENCES dtms.drivers(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
...
CREATE TABLE IF NOT EXISTS dtms.driver_task_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    driver_task_id uuid NOT NULL REFERENCES dtms.driver_tasks(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.execution_checklists (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.execution_checklist_items (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    checklist_id uuid NOT NULL REFERENCES dtms.execution_checklists(id) ON DELETE CASCADE,
    sequence_no integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.execution_check_results (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    checklist_item_id uuid NOT NULL REFERENCES dtms.execution_checklist_items(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    run_stop_id uuid REFERENCES dtms.run_stops(id),
    vehicle_id uuid REFERENCES dtms.vehicles(id),
    shipment_id uuid REFERENCES dtms.shipments(id),
    ...
    passed boolean,
    completed_by_driver_id uuid REFERENCES dtms.drivers(id),
    completed_by_user_id uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.scan_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    run_stop_id uuid REFERENCES dtms.run_stops(id),
    location_id uuid REFERENCES dtms.locations(id),
    scanned_by_driver_id uuid REFERENCES dtms.drivers(id),
    scanned_by_user_id uuid REFERENCES dtms.users(id),
    device_id uuid REFERENCES dtms.telematics_devices(id),
    latitude numeric(10,7),
    longitude numeric(11,7),
    occurred_at timestamptz NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.custody_transfers (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    handling_unit_id uuid REFERENCES dtms.handling_units(id),
    container_id uuid REFERENCES dtms.containers(id),
    shipment_id uuid REFERENCES dtms.shipments(id),
    from_custodian_partner_id uuid REFERENCES dtms.business_partners(id),
    to_custodian_partner_id uuid REFERENCES dtms.business_partners(id),
    location_id uuid REFERENCES dtms.locations(id),
    ...
    signature_file_id uuid REFERENCES dtms.files(id),
    notes text,
    created_at timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS dtms.sensor_devices (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.sensor_assignments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    sensor_id uuid NOT NULL REFERENCES dtms.sensor_devices(id),
...
CREATE TABLE IF NOT EXISTS dtms.sensor_readings (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    sensor_id uuid NOT NULL REFERENCES dtms.sensor_devices(id),
    assignment_id uuid REFERENCES dtms.sensor_assignments(id),
    shipment_id uuid REFERENCES dtms.shipments(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
...
CREATE TABLE IF NOT EXISTS dtms.sensor_alerts (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    sensor_id uuid NOT NULL REFERENCES dtms.sensor_devices(id),
    reading_id uuid REFERENCES dtms.sensor_readings(id),
    shipment_id uuid REFERENCES dtms.shipments(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    ...
    acknowledged_by uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.fuel_transactions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    vehicle_id uuid NOT NULL REFERENCES dtms.vehicles(id),
    driver_id uuid REFERENCES dtms.drivers(id),
    ...
    fuel_uom_code varchar(20) NOT NULL REFERENCES dtms.units_of_measure(uom_code),
    ...
    receipt_file_id uuid REFERENCES dtms.files(id),
    status varchar(20) NOT NULL DEFAULT 'POSTED',
    created_at timestamptz NOT NULL DEFAULT now(),
    CONSTRAINT ck_fuel_transaction_values CHECK (fuel_quantity > 0 AND net_amount >= 0 AND tax_amount >= 0 AND gross_amount >= 0)
);

CREATE TABLE IF NOT EXISTS dtms.toll_transactions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    vehicle_id uuid NOT NULL REFERENCES dtms.vehicles(id),
...
CREATE TABLE IF NOT EXISTS dtms.run_expenses (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    created_at timestamptz NOT NULL DEFAULT now(),
    CONSTRAINT ck_run_expense_amounts CHECK (net_amount >= 0 AND tax_amount >= 0 AND gross_amount >= 0)
);

CREATE TABLE IF NOT EXISTS dtms.execution_exceptions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    assigned_to_user_id uuid REFERENCES dtms.users(id),
    assigned_to_org_unit_id uuid REFERENCES dtms.organization_units(id),
...
CREATE TABLE IF NOT EXISTS dtms.exception_actions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    exception_id uuid NOT NULL REFERENCES dtms.execution_exceptions(id) ON DELETE CASCADE,
    action_type varchar(50) NOT NULL,
    action_description text NOT NULL,
    owner_user_id uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.incidents (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.incident_parties (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    incident_id uuid NOT NULL REFERENCES dtms.incidents(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.incident_items (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    incident_id uuid NOT NULL REFERENCES dtms.incidents(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.communications (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    thread_id uuid,
    ...
    sender_user_id uuid REFERENCES dtms.users(id),
    sender_partner_id uuid REFERENCES dtms.business_partners(id),
...
CREATE TABLE IF NOT EXISTS dtms.tracking_share_links (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.yard_visits (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    visit_no varchar(100) NOT NULL,
    yard_location_id uuid NOT NULL REFERENCES dtms.locations(id),
    run_id uuid REFERENCES dtms.transport_runs(id),
    appointment_id uuid REFERENCES dtms.dock_appointments(id),
    vehicle_id uuid REFERENCES dtms.vehicles(id),
    trailer_id uuid REFERENCES dtms.trailers(id),
    driver_id uuid REFERENCES dtms.drivers(id),
    carrier_id uuid REFERENCES dtms.business_partners(id),
    gate_in_at timestamptz,
    assigned_dock_id uuid REFERENCES dtms.location_docks(id),
...
CREATE TABLE IF NOT EXISTS dtms.yard_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    yard_visit_id uuid NOT NULL REFERENCES dtms.yard_visits(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.proof_of_deliveries (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    signature_file_id uuid REFERENCES dtms.files(id),
    primary_photo_file_id uuid REFERENCES dtms.files(id),
    document_file_id uuid REFERENCES dtms.files(id),
    driver_id uuid REFERENCES dtms.drivers(id),
    notes text,
    verification_status varchar(20) NOT NULL DEFAULT 'PENDING',
    verified_by uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.pod_signatures (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    pod_id uuid NOT NULL REFERENCES dtms.proof_of_deliveries(id) ON DELETE CASCADE,
    signer_role varchar(30) NOT NULL,
    signer_name_encrypted text,
    signature_file_id uuid NOT NULL REFERENCES dtms.files(id),
...
CREATE TABLE IF NOT EXISTS dtms.pod_items (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    pod_id uuid NOT NULL REFERENCES dtms.proof_of_deliveries(id) ON DELETE CASCADE,
    ...
    CONSTRAINT ck_pod_item_quantities CHECK (expected_quantity >= 0 AND delivered_quantity >= 0 AND refused_quantity >= 0 AND damaged_quantity >= 0)
);

CREATE TABLE IF NOT EXISTS dtms.delivery_discrepancies (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    pod_id uuid NOT NULL REFERENCES dtms.proof_of_deliveries(id) ON DELETE CASCADE,
    pod_item_id uuid REFERENCES dtms.pod_items(id),
    discrepancy_type varchar(30) NOT NULL,
    quantity numeric(20,6),
    uom_code varchar(20) REFERENCES dtms.units_of_measure(uom_code),
    severity varchar(20) NOT NULL DEFAULT 'MEDIUM',
    description text NOT NULL,
    photo_file_id uuid REFERENCES dtms.files(id),
...
CREATE TABLE IF NOT EXISTS dtms.damage_reports (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    handling_unit_id uuid REFERENCES dtms.handling_units(id),
    order_line_id uuid REFERENCES dtms.transport_order_lines(id),
    incident_id uuid REFERENCES dtms.incidents(id),
    pod_id uuid REFERENCES dtms.proof_of_deliveries(id),
    damage_type varchar(50) NOT NULL,
    damage_extent varchar(30),
    discovered_at timestamptz NOT NULL,
    discovered_location_id uuid REFERENCES dtms.locations(id),
