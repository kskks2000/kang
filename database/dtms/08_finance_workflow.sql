-- DTMS rating output, accrual, AP/AR invoice, Korean tax invoice, settlement, payment, accounting, and approvals.

CREATE TABLE IF NOT EXISTS dtms.charges (
    ...
    charge_code_id uuid NOT NULL REFERENCES dtms.charge_codes(id),
    ...
    run_stop_id uuid REFERENCES dtms.run_stops(id),
    claim_id uuid REFERENCES dtms.claims(id),
    payer_partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    payee_partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    contract_version_id uuid REFERENCES dtms.rate_contract_versions(id),
    rate_rule_id uuid REFERENCES dtms.rate_rules(id),
    rating_run_id uuid REFERENCES dtms.rating_runs(id),
    service_date date,
    ...
    currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    net_amount numeric(20,4) NOT NULL,
    tax_code_id uuid REFERENCES dtms.tax_codes(id),
    tax_rate_percent numeric(9,6),
    tax_amount numeric(20,4) NOT NULL DEFAULT 0,
    gross_amount numeric(20,4) NOT NULL,
    base_currency_code char(3) REFERENCES dtms.currencies(currency_code),
    ...
    reverses_charge_id uuid REFERENCES dtms.charges(id),
    description text,
...
CREATE TABLE IF NOT EXISTS dtms.charge_allocations (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    charge_id uuid NOT NULL REFERENCES dtms.charges(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.charge_adjustments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    charge_id uuid NOT NULL REFERENCES dtms.charges(id),
...
CREATE TABLE IF NOT EXISTS dtms.accruals (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    cost_center_id uuid REFERENCES dtms.cost_centers(id),
    partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    accrued_amount numeric(20,4) NOT NULL,
    base_currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    base_amount numeric(20,4) NOT NULL,
    status varchar(20) NOT NULL DEFAULT 'OPEN',
    reversed_at timestamptz,
    reversal_accrual_id uuid REFERENCES dtms.accruals(id),
...
CREATE TABLE IF NOT EXISTS dtms.invoices (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    issuer_partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    recipient_partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    issuer_party_snapshot_id uuid NOT NULL REFERENCES dtms.party_snapshots(id),
    recipient_party_snapshot_id uuid NOT NULL REFERENCES dtms.party_snapshots(id),
    billing_address_snapshot_id uuid REFERENCES dtms.address_snapshots(id),
    invoice_date date NOT NULL,
    service_period_from date,
    service_period_to date,
    posting_date date,
    due_date date,
    payment_term_id uuid REFERENCES dtms.payment_terms(id),
    currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    exchange_rate numeric(24,12),
    exchange_rate_date date,
    base_currency_code char(3) REFERENCES dtms.currencies(currency_code),
    ...
    original_invoice_id uuid REFERENCES dtms.invoices(id),
...
CREATE TABLE IF NOT EXISTS dtms.invoice_lines (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    invoice_id uuid NOT NULL REFERENCES dtms.invoices(id) ON DELETE CASCADE,
    line_no integer NOT NULL,
    charge_code_id uuid REFERENCES dtms.charge_codes(id),
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conrelid = 'dtms.accruals'::regclass
          AND conname = 'fk_accruals_invoice_line'
    ) THEN
        ALTER TABLE dtms.accruals
            ADD CONSTRAINT fk_accruals_invoice_line FOREIGN KEY (invoice_line_id)
            REFERENCES dtms.invoice_lines(id) ON DELETE SET NULL;
    END IF;
END;
$block$;

CREATE TABLE IF NOT EXISTS dtms.invoice_line_charges (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    invoice_line_id uuid NOT NULL REFERENCES dtms.invoice_lines(id) ON DELETE CASCADE,
    charge_id uuid NOT NULL REFERENCES dtms.charges(id),
    allocated_net_amount numeric(20,4) NOT NULL,
    allocated_tax_amount numeric(20,4) NOT NULL DEFAULT 0,
    allocated_gross_amount numeric(20,4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS dtms.invoice_taxes (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    invoice_id uuid NOT NULL REFERENCES dtms.invoices(id) ON DELETE CASCADE,
    tax_code_id uuid NOT NULL REFERENCES dtms.tax_codes(id),
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_invoice_taxes_scope
    ON dtms.invoice_taxes (
        invoice_id, tax_code_id, tax_rate_percent, COALESCE(jurisdiction_code, '')
    );

CREATE TABLE IF NOT EXISTS dtms.invoice_match_results (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    invoice_id uuid NOT NULL REFERENCES dtms.invoices(id) ON DELETE CASCADE,
    invoice_line_id uuid REFERENCES dtms.invoice_lines(id) ON DELETE CASCADE,
    ...
    matched_by uuid REFERENCES dtms.users(id),
    CONSTRAINT ck_invoice_match_entity CHECK (invoice_line_id IS NOT NULL OR matched_entity_id IS NOT NULL)
);

CREATE TABLE IF NOT EXISTS dtms.invoice_disputes (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    dispute_no varchar(100) NOT NULL,
    invoice_id uuid NOT NULL REFERENCES dtms.invoices(id),
    invoice_line_id uuid REFERENCES dtms.invoice_lines(id),
    raised_by_partner_id uuid REFERENCES dtms.business_partners(id),
    disputed_partner_id uuid REFERENCES dtms.business_partners(id),
    dispute_type varchar(50) NOT NULL,
    disputed_amount numeric(20,4) NOT NULL,
    currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    reason text NOT NULL,
    status varchar(20) NOT NULL DEFAULT 'OPEN',
    assigned_to uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.invoice_dispute_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    dispute_id uuid NOT NULL REFERENCES dtms.invoice_disputes(id) ON DELETE CASCADE,
    ...
    actor_partner_id uuid REFERENCES dtms.business_partners(id),
    file_id uuid REFERENCES dtms.files(id),
    occurred_at timestamptz NOT NULL DEFAULT now()
);

CREATE TABLE IF NOT EXISTS dtms.invoice_status_history (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    invoice_id uuid NOT NULL REFERENCES dtms.invoices(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.tax_invoices (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    direction varchar(10) NOT NULL,
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    supplier_partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    buyer_partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    supplier_snapshot_id uuid NOT NULL REFERENCES dtms.party_snapshots(id),
    buyer_snapshot_id uuid NOT NULL REFERENCES dtms.party_snapshots(id),
    issue_date date NOT NULL,
    supply_date date NOT NULL,
    currency_code char(3) NOT NULL DEFAULT 'KRW' REFERENCES dtms.currencies(currency_code),
    ...
    original_tax_invoice_id uuid REFERENCES dtms.tax_invoices(id),
...
CREATE TABLE IF NOT EXISTS dtms.tax_invoice_lines (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tax_invoice_id uuid NOT NULL REFERENCES dtms.tax_invoices(id) ON DELETE CASCADE,
    line_no integer NOT NULL,
    invoice_id uuid REFERENCES dtms.invoices(id),
    invoice_line_id uuid REFERENCES dtms.invoice_lines(id),
    supply_date date,
...
CREATE TABLE IF NOT EXISTS dtms.tax_invoice_events (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tax_invoice_id uuid NOT NULL REFERENCES dtms.tax_invoices(id) ON DELETE CASCADE,
    event_type varchar(50) NOT NULL,
    from_status varchar(30),
...
CREATE TABLE IF NOT EXISTS dtms.settlement_batches (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    ...
    created_by uuid REFERENCES dtms.users(id),
    closed_by uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.settlements (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    settlement_no varchar(120) NOT NULL,
    batch_id uuid REFERENCES dtms.settlement_batches(id),
    settlement_type varchar(20) NOT NULL,
    partner_id uuid NOT NULL REFERENCES dtms.business_partners(id),
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    period_from date NOT NULL,
    ...
    approved_at timestamptz,
    invoice_id uuid REFERENCES dtms.invoices(id),
    statement_file_id uuid REFERENCES dtms.files(id),
    row_version bigint NOT NULL DEFAULT 1,
    created_at timestamptz NOT NULL DEFAULT now(),
    updated_at timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS dtms.settlement_lines (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    settlement_id uuid NOT NULL REFERENCES dtms.settlements(id) ON DELETE CASCADE,
    line_no integer NOT NULL,
    line_type varchar(30) NOT NULL,
    charge_id uuid REFERENCES dtms.charges(id),
    invoice_line_id uuid REFERENCES dtms.invoice_lines(id),
    claim_settlement_id uuid REFERENCES dtms.claim_settlements(id),
    description text NOT NULL,
    gross_amount numeric(20,4) NOT NULL,
    deduction_amount numeric(20,4) NOT NULL DEFAULT 0,
    tax_amount numeric(20,4) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS dtms.payments (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.payment_applications (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    payment_id uuid NOT NULL REFERENCES dtms.payments(id) ON DELETE CASCADE,
    invoice_id uuid REFERENCES dtms.invoices(id),
    settlement_id uuid REFERENCES dtms.settlements(id),
    claim_settlement_id uuid REFERENCES dtms.claim_settlements(id),
...
CREATE TABLE IF NOT EXISTS dtms.accounting_periods (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
...
CREATE TABLE IF NOT EXISTS dtms.gl_accounts (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    ...
    parent_account_id uuid REFERENCES dtms.gl_accounts(id),
    currency_code char(3) REFERENCES dtms.currencies(currency_code),
...
CREATE TABLE IF NOT EXISTS dtms.journal_batches (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    batch_no varchar(100) NOT NULL,
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    accounting_period_id uuid NOT NULL REFERENCES dtms.accounting_periods(id),
    source_code varchar(50) NOT NULL DEFAULT 'DTMS',
    ...
    posted_at timestamptz,
    posted_by uuid REFERENCES dtms.users(id),
    reversal_of_batch_id uuid REFERENCES dtms.journal_batches(id),
    row_version bigint NOT NULL DEFAULT 1,
    created_at timestamptz NOT NULL DEFAULT now(),
    updated_at timestamptz NOT NULL DEFAULT now(),
    UNIQUE (tenant_id, batch_no),
...
CREATE TABLE IF NOT EXISTS dtms.journal_entries (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    journal_batch_id uuid NOT NULL REFERENCES dtms.journal_batches(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.journal_lines (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    journal_entry_id uuid NOT NULL REFERENCES dtms.journal_entries(id) ON DELETE CASCADE,
    line_no integer NOT NULL,
    gl_account_id uuid NOT NULL REFERENCES dtms.gl_accounts(id),
    cost_center_id uuid REFERENCES dtms.cost_centers(id),
...
CREATE TABLE IF NOT EXISTS dtms.accounting_exports (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    export_no varchar(100) NOT NULL,
    external_system_id uuid NOT NULL REFERENCES dtms.external_systems(id),
    organization_id uuid NOT NULL REFERENCES dtms.organizations(id),
    accounting_period_id uuid REFERENCES dtms.accounting_periods(id),
...
CREATE TABLE IF NOT EXISTS dtms.cost_allocations (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    source_entity_type varchar(30) NOT NULL,
    source_entity_id uuid NOT NULL,
    allocation_rule_code varchar(80),
    target_cost_center_id uuid NOT NULL REFERENCES dtms.cost_centers(id),
    allocation_percent numeric(9,6),
    allocated_amount numeric(20,4) NOT NULL,
    currency_code char(3) NOT NULL REFERENCES dtms.currencies(currency_code),
    accounting_date date NOT NULL,
    journal_line_id uuid REFERENCES dtms.journal_lines(id),
    created_at timestamptz NOT NULL DEFAULT now(),
    CONSTRAINT ck_cost_allocation_percent CHECK (allocation_percent IS NULL OR allocation_percent BETWEEN 0 AND 100)
);

CREATE TABLE IF NOT EXISTS dtms.workflow_definitions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.workflow_versions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    workflow_definition_id uuid NOT NULL REFERENCES dtms.workflow_definitions(id) ON DELETE CASCADE,
    version_no integer NOT NULL,
    effective_from timestamptz NOT NULL,
    effective_to timestamptz,
    trigger_conditions jsonb NOT NULL DEFAULT '{}'::jsonb,
    status varchar(20) NOT NULL DEFAULT 'DRAFT',
    published_by uuid REFERENCES dtms.users(id),
...
CREATE TABLE IF NOT EXISTS dtms.workflow_steps (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    workflow_version_id uuid NOT NULL REFERENCES dtms.workflow_versions(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS dtms.workflow_instances (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    workflow_version_id uuid NOT NULL REFERENCES dtms.workflow_versions(id),
    entity_type varchar(80) NOT NULL,
    entity_id uuid NOT NULL,
    status varchar(20) NOT NULL DEFAULT 'RUNNING',
    current_step_id uuid REFERENCES dtms.workflow_steps(id),
...
CREATE TABLE IF NOT EXISTS dtms.workflow_tasks (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    workflow_instance_id uuid NOT NULL REFERENCES dtms.workflow_instances(id) ON DELETE CASCADE,
    workflow_step_id uuid NOT NULL REFERENCES dtms.workflow_steps(id),
    task_no integer NOT NULL,
    assignee_user_id uuid REFERENCES dtms.users(id),
    assignee_group_id uuid REFERENCES dtms.user_groups(id),
    status varchar(20) NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS dtms.approval_policies (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
...
CREATE TABLE IF NOT EXISTS dtms.approval_requests (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    tenant_id uuid NOT NULL REFERENCES dtms.tenants(id),
    request_no varchar(100) NOT NULL,
    policy_id uuid REFERENCES dtms.approval_policies(id),
    workflow_instance_id uuid REFERENCES dtms.workflow_instances(id),
    entity_type varchar(80) NOT NULL,
    entity_id uuid NOT NULL,
    amount numeric(20,4),
    currency_code char(3) REFERENCES dtms.currencies(currency_code),
    reason text,
    status varchar(20) NOT NULL DEFAULT 'PENDING',
    requested_by uuid NOT NULL REFERENCES dtms.users(id),
    requested_at timestamptz NOT NULL DEFAULT now(),
    completed_at timestamptz,
    row_version bigint NOT NULL DEFAULT 1,
    created_at timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS dtms.approval_steps (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    approval_request_id uuid NOT NULL REFERENCES dtms.approval_requests(id) ON DELETE CASCADE,
    level_no integer NOT NULL,
    approver_user_id uuid REFERENCES dtms.users(id),
    approver_group_id uuid REFERENCES dtms.user_groups(id),
    status varchar(20) NOT NULL DEFAULT 'PENDING',
    assigned_at timestamptz NOT NULL DEFAULT now(),
    due_at timestamptz,
    ...
    decision varchar(20),
    comments text,
    delegated_from_user_id uuid REFERENCES dtms.users(id),
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_approval_steps_user
    ON dtms.approval_steps (approval_request_id, level_no, approver_user_id)
    WHERE approver_user_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS ux_approval_steps_group
    ON dtms.approval_steps (approval_request_id, level_no, approver_group_id)
    WHERE approver_group_id IS NOT NULL;

CREATE TABLE IF NOT EXISTS dtms.approval_actions (
    id uuid PRIMARY KEY DEFAULT dtms.generate_uuid(),
    approval_step_id uuid NOT NULL REFERENCES dtms.approval_steps(id) ON DELETE CASCADE,
    action_type varchar(20) NOT NULL,
    actor_user_id uuid NOT NULL REFERENCES dtms.users(id),
    comments text,
    ip_address inet,
    user_agent text,
    occurred_at timestamptz NOT NULL DEFAULT now(),
